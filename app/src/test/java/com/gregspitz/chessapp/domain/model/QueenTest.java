...
public class QueenTest {
    ...
    @Before
    public void setup() {
        mWhiteQueen = new Queen(true);
        mBlackQueen = new Queen(false);
    }

    @Test
    public void blackAndWhiteQueen_canMoveVerticallyAnyNumberOfSquares() {
        for (int i = 1; i < 20; i++) {
            assertTrue(mWhiteQueen.canMove(STARTING_FILE, STARTING_RANK,
                    STARTING_FILE, STARTING_RANK + i));
            assertTrue(mWhiteQueen.canMove(STARTING_FILE, STARTING_RANK,
                    STARTING_FILE, STARTING_RANK - i));
            assertTrue(mBlackQueen.canMove(STARTING_FILE, STARTING_RANK,
                    STARTING_FILE, STARTING_RANK - i));
            assertTrue(mBlackQueen.canMove(STARTING_FILE, STARTING_RANK,
                    STARTING_FILE, STARTING_RANK + i));
        }
